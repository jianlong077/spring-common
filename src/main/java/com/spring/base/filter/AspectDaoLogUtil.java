...
public  abstract class AspectDaoLogUtil {
		@Around("execution(* com.spring.base.dao.impl.ExampleBaseDaoimpl.*(..))")
		public void aroundDao(ProceedingJoinPoint pjp) throws Throwable {
			around( pjp);
		}
