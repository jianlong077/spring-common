...
public  abstract class AspectServiceLogUtil {		
	  @Around("execution(* com.spring.base.service.impl.ExampleBaseServiceImpl.*(..))") 
	  public void  aroundService(ProceedingJoinPoint pjp) throws Throwable { around( pjp); }	
